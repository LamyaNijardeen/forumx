...
<main class="layout">
    <div class="main">
        <?php if (empty($posts)): ?>
            <div class="card">
                <p>No posts yet. <?php if ($user) echo '<a href="create_blog.php">Create the first post</a>.'; ?></p>
            </div>
        <?php else: ?>
            <?php foreach ($posts as $post): ?>
                <article class="card">
                    ...
                    <div style="margin-top:10px;">
                        <a href="view_blog.php?id=<?php echo $post['id']; ?>">Read more</a>
                        <?php if ($user && ($user['id'] == $post['user_id'] || is_admin())): ?>
                            <span style="margin-left:10px;"><a href="edit_blog.php?id=<?php echo $post['id']; ?>">Edit</a></span>
                            <form action="delete_post.php" method="POST" style="display:inline;margin-left:8px" onsubmit="return confirm('Delete this post?');">
    ...
    <aside class="sidebar">
        <div class="profile-card">
            ...
            <?php if (!$user): ?>
                <p><a class="button" href="register.php">Join ForumX</a></p>
            <?php else: ?>
                <p><a class="button" href="create_blog.php">Write a story</a></p>
            <?php endif; ?>
        </div>
    </aside>
</main>
