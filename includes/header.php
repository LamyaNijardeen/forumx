...
<header class="fx-header" role="banner">
  <div class="fx-container fx-header-inner">
    ...
    <div class="fx-brand">
      ...
      <?php else: ?>
        <a href="/forumx/pages/entry.php">ForumX</a>
      <?php endif; ?>
    </div>
    ...
    <?php if ($user): ?>
      <div class="fx-search">
        <form action="/forumx/pages/home.php" method="GET" role="search" class="fx-search-form">
    ...
    <nav class="fx-nav" role="navigation">
      <?php if ($user): ?>
        ...
        <div class="fx-nav-right">
          ...
          <a href="/forumx/pages/logout.php" class="fx-logout">Logout</a>
        </div>
      <?php else: ?>
        <div class="fx-nav-left">
          <a href="/forumx/pages/about.php">About</a>
          <a href="/forumx/pages/register.php">Write</a>
        </div>
        <div class="fx-nav-right">
          <a href="/forumx/pages/register.php" class="fx-cta">Get Started</a>
        </div>
      <?php endif; ?>
    </nav>
  </div>
